...
totalIncome([],0).
totalIncome([Individual|Family], TotalIncome) :- 
...
# Income of all families less than 2000 per person
# ?- family(Husband, Wife, Children), totalIncome([Husband, Wife | Children], TotalIncome), length([Husband, Wife|Children], NumberOfPeople), ((TotalIncome/NumberOfPeople)<2000).

# Income of children is more than income of parents
# ?- family(Husband, Wife, Children), totalIncome(Children, TotalIncomeChildren), totalIncome([Husband, Wife], TotalIncomeParents), TotalIncomeChildren>TotalIncomeParents.